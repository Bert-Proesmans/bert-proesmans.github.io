...
redirect_from: ["/proesmans-whats-that/"]
...
<div><custom-youtube @slug="CFO0mrAwEbM" @label="ʏᴏᴜ ʟɪᴋᴇ ᴀꜱꜱ??? 【Hololive】"></custom-youtube></div>
...
<div><custom-youtube @slug="2eP8AoXnQ54" @start="25710" @label="prˈøːsmɑns"></custom-youtube></div>

<!-- [[prˈoːsmɑns]](https://youtube.com/clip/Ugkx-GcjEpBOo60DXz81I5UyppOddNEzaNkW) -->
<div><custom-youtube @slug="vE8Nz5WAebs" @start="3380" @label="prˈoːsmɑns"></custom-youtube></div>

So meet my new alter ego;

<!-- [Pretzelmans](https://youtube.com/clip/Ugkx9GXUpdf7zJl7xm9CG7fvUMarfKSRftbX) -->
<div><custom-youtube @slug="5MN8NZMG9bA" @start="11317" @label="Pretzelmans"></custom-youtube></div>

[^wikipedia_pretzelmans]

<!-- [Apfelstrudelmans](https://youtube.com/clip/UgkxMeKLuuNHerDvXFkGfSogplDUAuCCVdJA) -->
<div><custom-youtube @slug="bFgkZGRIQoU" @start="21313" @label="Apfelstrudelmans"></custom-youtube></div>

[^wikipedia_pretzelmans]:
    Wikipedia tells me that a Pretzel is originally named "Brezel". Pretzel is an americanization, 
    which I'm surprised to hear because I live a literal 60 minute drive away from Germany. Yet, I also use the word "Pretzel".

---
I publish immediately for peace of mind, and regularly revisit my content to look for opportunities to improve.

**"I don't give a penny. Fuck 2020!"** - _[FCK 2020, by Scooter](https://www.youtube.com/watch?v=zu3k2PJumfI)_