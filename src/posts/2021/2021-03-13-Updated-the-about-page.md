...
redirect_from: ["/updated-the-about-page/"]
...
At this point in time I updated the about-page (see below), website title, configuration and yeeted the Jeckyll static site framework. Basically, I made a new site...  
...
This post is about a previous iteration of the about page. It's contents are stored inside this article for posterity[^cringe].  
Find the new and current [about page here](/about/).

[^cringe]:
    Preserve the cringe! Even though it might hurt (mentally), I don't remove or change history out of principle.
