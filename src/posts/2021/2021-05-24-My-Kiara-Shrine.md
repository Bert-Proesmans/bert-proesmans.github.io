...
Third, and possibly last, installment of my series about [Kiara Takanashi](https://virtualyoutuber.fandom.com/wiki/Takanashi_Kiara). The [first part](/thank-you-Kiara) contained some vague and unfocused amalgamation of a story about my latest 'obsession'.  
The [second part](/gushing-over-Kiara) describes how I got hooked. <!-- more -->
...
> Don't like to read that much? Check the [FAQ section](#faq-quick-shots) that also intends to summarize the experience a bit.
...
"Why?" is a good question. I like her very much, as explained in [part 2](/gushing-over-Kiara). But I also cannot correctly moderate myself. In practice, I'm very black/white about time investment. There is no middle ground; I do or do not.  
...
**"Man, I'm tired! I'll sleep on the plane."** - _Bad idea factory_

<script type="module" src="/assets/scripts/components/custom-easteregg.js"></script>
<custom-easteregg keyword="kiara" shape="❤️" particle-count="50"></custom-easteregg>